...
```
Load: .cursor/rules/shared/niko/visual-maps/creative-mode-map.mdc
```

### Step 3: Load Creative Phase Enforcement
```
Load: .cursor/rules/shared/niko/Core/creative-phase-enforcement.mdc
Load: .cursor/rules/shared/niko/Core/creative-phase-metrics.mdc
```
...
```
Load: .cursor/rules/shared/niko/Phases/CreativePhase/creative-phase-architecture.mdc
```

**For UI/UX Design:**
```
Load: .cursor/rules/shared/niko/Phases/CreativePhase/creative-phase-uiux.mdc
```

**For Algorithm Design:**
```
Load: .cursor/rules/shared/niko/Phases/CreativePhase/creative-phase-algorithm.mdc
```
